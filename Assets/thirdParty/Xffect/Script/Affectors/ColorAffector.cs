...
namespace Xft{
    ...
    public class ColorAffector : Affector
    {
        ...
        public override void Reset()
        {
			...
			{
				Debug.LogWarning("invalid color gradual time, loop node can't be gradient by 'gradual time':" + mOwner.ColorGradualTimeLength);
			}
        ...
        public override void Update(float deltaTime)
        {
			...
			if (t > 1f)
			{
				...
				{
					Node.Color = mOwner.ColorParam.GetGradientColor(1f);
					return;
				}
            ...
            Node.Color = mOwner.ColorParam.GetGradientColor(t);
        }
    }
}
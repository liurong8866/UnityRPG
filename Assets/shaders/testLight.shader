...
/////// Diffuse:
                ...
                float2 node_6 = i.uv0;
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_6.rg, _node_2)).rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                float3 diffuseLight = diffuse;
                float2 node_7 = i.uv0;
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_7.rg, _node_2)).rgb;
/// Final Color:
